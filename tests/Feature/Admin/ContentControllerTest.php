...
describe('Admin Content Management', function () {
    beforeEach(function () {
    ...
    it('lists content items', function () {
        // Create a dummy item
    ...
    it('creates content item with html', function () {
        // 1. Create Type
    ...
    it('creates content item', function () {
    ...
    it('edits content item', function () {
    ...
    it('deletes content item', function () {
