                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg max-w-2xl mx-auto p-6">
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="mb-6 pb-6 border-b border-gray-200">
                            <h3 class="text-sm font-medium text-gray-900 mb-3">Content Type Settings</h3>
                            <div class="space-y-3">
                                <div class="flex items-start">
                                    ...
                                    <label for="is_public" class="ml-2 block text-sm">
                                        <span class="font-medium text-gray-900">Public Access</span>
                                        <span class="text-gray-500 block text-xs mt-0.5">Allow unauthenticated users to
                                ...
                                <div class="flex items-start">
                                    ...
                                    <label for="has_ownership" class="ml-2 block text-sm">
                                        <span class="font-medium text-gray-900">User Ownership</span>
                                        <span class="text-gray-500 block text-xs mt-0.5">Track which user created each
                                            content item</span>
                                    </label>
                                </div>
                            </div>
